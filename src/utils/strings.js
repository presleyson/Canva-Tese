export const leftTopArea = {
  titles: ['Principais Parceiros', 'Recursos Técnicos', 'Recursos Financeiros', 'Ideias Selecionadas', 'Geração de ideias'],
  id: ['text-canva-area-principais-parceiros', 'text-canva-area-recursos-tecnicos', 'text-canva-area-recursos-financeiros', 'text-canva-area-ideias-selecionadas', 'text-canva-area-geracao-ideias'],
};

export const rightTopArea = {
  titles: ['Mercado', 'Problema'],
  id: ['text-canva-area-mercado', 'text-canva-area-problema'],
};

export const bottomArea = {
  titles: ['Resultados', 'Planejamento Estratégico'],
  id: ['text-canva-area-resultados', 'text-canva-area-planejamento-estrategico'],
};
